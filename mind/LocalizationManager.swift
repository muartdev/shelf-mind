...
struct LocalizedStrings {
    ...
    private static let english: [String: String] = [
        ...
        "paywall.subscription.disclosure": "Subscriptions renew automatically unless canceled at least 24 hours before the end of the period. Manage or cancel anytime in App Store settings. Payment is charged to your Apple ID at confirmation. By subscribing, you agree to the Terms of Use (EULA) and Privacy Policy.",
        "paywall.loading": "Loading plans...",
        "paywall.error": "Unable to load plans",
        "paywall.unavailable": "Premium plans are temporarily unavailable. Please try again later.",
        "paywall.retry": "Retry",
    ...
    private static let turkish: [String: String] = [
        ...
        "paywall.subscription.disclosure": "Abonelikler, dönem bitiminden en az 24 saat önce iptal edilmediği takdirde otomatik olarak yenilenir. Aboneliği App Store ayarlarından istediğin zaman yönetebilir veya iptal edebilirsin. Ödeme, onay sırasında Apple Kimliğine işlenir. Abone olarak Kullanım Koşulları (EULA) ve Gizlilik Politikası'nı kabul etmiş olursun.",
        "paywall.loading": "Planlar yükleniyor...",
        "paywall.error": "Planlar yüklenemedi",
        "paywall.unavailable": "Premium planlar geçici olarak kullanılamıyor. Lütfen daha sonra tekrar deneyin.",
