        ...
        <div className="text-center max-w-3xl mx-auto relative">
          ...
          <div className="relative mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            {!user && (
              <Link
                to="/login"
                className="px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl text-white font-semibold text-base sm:text-lg shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl text-center"
            ...
            <a
              ...
              className={`inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl ${theme.cardBg} border ${theme.cardBorder} ${theme.text} font-semibold text-base sm:text-lg transition-all hover:-translate-y-0.5 backdrop-blur`}
            >
