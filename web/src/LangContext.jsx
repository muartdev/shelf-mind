...
const translations = {
  en: {
    ...
    'login.resent': 'Confirmation email sent again! Check your inbox.',
    'login.resendWait': 'Resend again in',
  ...
  tr: {
    ...
    'login.checkEmail': 'Hesabınızı onaylamak için e-postanızı kontrol edin.',
    'login.resend': 'Doğrulama mailini tekrar gönder',
    'login.resent': 'Doğrulama maili tekrar gönderildi! Gelen kutunuzu kontrol edin.',
    'login.resendWait': 'Tekrar göndermek için bekleyin',
